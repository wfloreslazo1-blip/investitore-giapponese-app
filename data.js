...
const CAREER_BADGES = [
  ...
  { "id": "come-muoversi-trailhead", "name": "Come muoversi in Trailhead", "meta": "Unità Trailhead — 100 punti — completata il 16/05/2026 (moduli, progetti, itinerari, trailmix, superbadge, certificazioni)" },
...
const CAREER_QUIZ = [
  ...
  { "id": "c61", "badge": "come-muoversi-trailhead", "section": 1, "sectionTitle": "Ecosistema Salesforce", "question": "Vero o falso: gli itinerari sono percorsi di apprendimento guidati composti da moduli e progetti.", "options": ["Vero", "Falso"], "correct": 0, "explanation": "\"Gli itinerari sono percorsi di apprendimento guidati composti da moduli e progetti che ti aiutano a esplorare argomenti e ad acquisire competenze utili ed esperienza pratica sui prodotti Salesforce.\"" },
  { "id": "c62", "badge": "come-muoversi-trailhead", "section": 1, "sectionTitle": "Ecosistema Salesforce", "question": "Qual è il vantaggio del conseguimento di una certificazione Salesforce?", "options": ["Permette di dimostrare l'esperienza pratica con i prodotti Salesforce, arricchendo il curriculum e convalidando le competenze", "Dà accesso gratuito illimitato a tutti i prodotti Salesforce", "Sostituisce la necessità di completare moduli e progetti su Trailhead", "È obbligatoria per poter creare un Trailhead Playground"], "correct": 0, "explanation": "Le certificazioni Salesforce permettono di dimostrare l'esperienza pratica con i prodotti Salesforce: sono utili per arricchire il curriculum e convalidare le competenze." },
  { "id": "c63", "badge": "come-muoversi-trailhead", "section": 1, "sectionTitle": "Ecosistema Salesforce", "question": "Che cosa sono i \"moduli\" su Trailhead?", "options": ["Unità di breve durata che trattano argomenti specifici", "Percorsi di apprendimento guidati composti da più contenuti", "Sfide pratiche senza istruzioni passo-passo", "Percorsi di apprendimento personalizzati creati da te"], "correct": 0, "explanation": "\"I moduli sono unità di breve durata che trattano argomenti specifici.\"" },
  { "id": "c64", "badge": "come-muoversi-trailhead", "section": 1, "sectionTitle": "Ecosistema Salesforce", "question": "Che cosa sono i \"progetti\" su Trailhead?", "options": ["Aiutano ad acquisire nuove competenze con esercitazioni pratiche in un Trailhead Playground, con istruzioni passo passo", "Sono percorsi di apprendimento personalizzati creati da te", "Sono sfide pratiche senza istruzioni dettagliate, su problemi aziendali reali", "Sono l'equivalente di una certificazione ufficiale"], "correct": 0, "explanation": "\"I progetti ti aiutano ad acquisire nuove competenze con esercitazioni pratiche all'interno di un Trailhead Playground, accompagnandoti con istruzioni passo passo.\"" },
  { "id": "c65", "badge": "come-muoversi-trailhead", "section": 1, "sectionTitle": "Ecosistema Salesforce", "question": "Su quali piattaforme puoi navigare in Trailhead, secondo questa unità?", "options": ["Solo su computer desktop", "Computer desktop, telefono e persino Slack", "Solo tramite l'app mobile Trailhead GO", "Solo all'interno della Trailblazer Community"], "correct": 1, "explanation": "È possibile imparare a navigare in Trailhead \"su computer desktop, telefono o persino in Slack\"." },
  { "id": "c66", "badge": "come-muoversi-trailhead", "section": 1, "sectionTitle": "Ecosistema Salesforce", "question": "Dove puoi entrare in contatto con trailblazer di tutto il mondo per ricevere supporto e consigli lungo il tuo percorso di apprendimento?", "options": ["Nella Trailblazer Community", "Nell'AppExchange", "Nel Trailhead Playground", "Nel menu Setup dell'org"], "correct": 0, "explanation": "\"Non devi affrontare questo viaggio di apprendimento in solitaria: nella Trailblazer Community puoi entrare in contatto con trailblazer di tutto il mondo per ricevere supporto e consigli.\"" },
  { "id": "c67", "badge": "agentforce-360-platform-basics", "section": 3, "sectionTitle": "Modello dati", "question": "In Salesforce, what is an 'object'?", "options": ["A table in the Salesforce database that stores a particular kind of information", "A row in a database table", "A column in a database table", "A specific instance of Salesforce"], "correct": 0, "explanation": "\"Objects are tables in the Salesforce database that store a particular kind of information. There are standard objects like Accounts and Contacts and custom objects like the Property object.\"" },
  { "id": "c68", "badge": "agentforce-360-platform-basics", "section": 3, "sectionTitle": "Modello dati", "question": "What is a 'record' in Salesforce?", "options": ["A row in an object's database table — the actual data associated with an object", "A table that stores a kind of information", "A column in an object's table", "A custom field added to an object"], "correct": 0, "explanation": "\"Records are rows in object database tables. Records are the actual data associated with an object.\"" },
  { "id": "c69", "badge": "agentforce-360-platform-basics", "section": 3, "sectionTitle": "Modello dati", "question": "What is a 'field' in Salesforce?", "options": ["A column in an object's database table", "A row of data in an object", "A table storing records", "An app made of objects and functionality"], "correct": 0, "explanation": "\"Fields are columns in object database tables. Both standard and custom objects have fields. On our Property object, we have fields like Address and Price.\"" },
  { "id": "c70", "badge": "agentforce-360-platform-basics", "section": 1, "sectionTitle": "Ecosistema Salesforce", "question": "What does 'org' stand for in Salesforce, and what does it refer to?", "options": ["Short for 'organization' — a specific instance of Salesforce", "Short for 'origin' — the source system data was imported from", "Short for 'organizer' — a personal task-management tool", "Short for 'orchestration' — the workflow automation engine"], "correct": 0, "explanation": "\"Org is short for organization, and it refers to a specific instance of Salesforce. Your company can have one or multiple orgs.\"" },
  { "id": "c71", "badge": "agentforce-360-platform-basics", "section": 2, "sectionTitle": "Navigazione", "question": "What is a Trailhead Playground?", "options": ["A special type of Developer Edition (DE) org, used as a safe environment to practice Salesforce skills", "A sandbox available only to Salesforce admins", "A paid production org used for real customer data", "A mobile-only testing app"], "correct": 0, "explanation": "\"A Trailhead Playground is a safe environment where you can practice the skills you're learning... a playground is in fact a special type of Developer Edition (DE) org.\"" },
  { "id": "c72", "badge": "agentforce-360-platform-basics", "section": 2, "sectionTitle": "Navigazione", "question": "In the 'Unlock Business Success with Salesforce Data Platform' unit, how does D'Angelo add a 'Prequalified?' checkbox field to the Contact object?", "options": ["Through Setup > Object Manager > Contact > Fields & Relationships > New, without writing any code", "By writing Apex code in the Developer Console", "By installing a package from AppExchange", "By importing a new field with Data Loader"], "correct": 0, "explanation": "This is no-code (declarative) development: \"With no-code development, you use forms and drag-and-drop tools to perform powerful customization tasks... Click Setup, then Object Manager, then Contact, then Fields & Relationships, then New.\"" }
];
...
const CAREER_GLOSSARY = [
  ...
  { "id": "g70", "category": "Ecosistema & community", "term": "Itinerario (Trail)", "definition": "Percorso di apprendimento guidato composto da moduli e progetti, che aiuta a esplorare un argomento e ad acquisire competenze utili ed esperienza pratica sui prodotti Salesforce." },
  { "id": "g71", "category": "Ecosistema & community", "term": "Progetto (Trailhead)", "definition": "Esercitazione pratica, con istruzioni passo passo, che aiuta ad acquisire nuove competenze lavorando dentro un Trailhead Playground." },
  { "id": "g72", "category": "Modello dati", "term": "Object (Salesforce)", "definition": "A table in the Salesforce database that stores a particular kind of information — standard (e.g. Account, Contact) or custom (e.g. Property)." },
  { "id": "g73", "category": "Modello dati", "term": "Record", "definition": "A row in an object's database table — the actual data stored for that object (e.g. one specific property or contact)." },
  { "id": "g74", "category": "Modello dati", "term": "Field", "definition": "A column in an object's database table. Both standard and custom objects can have fields (e.g. Prequalified?, Loan Amount)." },
  { "id": "g75", "category": "Ecosistema & community", "term": "Org", "definition": "Short for 'organization' — a specific instance of Salesforce. A company can have one or several orgs." },
  { "id": "g76", "category": "Navigazione", "term": "App (Salesforce)", "definition": "A set of objects, fields, and other functionality that supports a business process. You switch between apps with the App Launcher." },
  { "id": "g77", "category": "Ecosistema & community", "term": "Developer Edition (DE) org", "definition": "A free, full-featured Salesforce org used for building and testing. A Trailhead Playground is a special type of DE org." },
  { "id": "g78", "category": "Navigazione", "term": "No-code (declarative) development", "definition": "Building functionality using forms and drag-and-drop tools in Setup, without writing code — e.g. adding a custom field via Object Manager." },
  { "id": "g79", "category": "Navigazione", "term": "Programmatic development", "definition": "Building functionality by writing code, e.g. using Lightning components, as opposed to no-code/declarative tools." }
];
