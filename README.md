...
- **Carriera** — preparazione alla certificazione **Salesforce Certified Associate**, basata sul trailmix [Prepare for your Salesforce Certified Associate Credential](https://trailhead.salesforce.com/it/users/strailhead/trailmixes/prepare-for-your-salesforce-certified-associate-credential). 40 domande scritte sulle 4 sezioni ufficiali dell'esame (Ecosistema Salesforce, Navigazione, Modello dati, Report e Dashboard), pesate secondo la percentuale reale di ciascuna sezione. Una checklist ti permette di segnare le sezioni già studiate sul trailmix; poi Flashcard, Quiz a scelta multipla e Statistiche funzionano come nelle altre sezioni.
