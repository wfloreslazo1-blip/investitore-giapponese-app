...
- **Carriera** — preparazione alla certificazione **Salesforce Certified Associate**, basata sul trailmix [Prepare for your Salesforce Certified Associate Credential](https://trailhead.salesforce.com/it/users/strailhead/trailmixes/prepare-for-your-salesforce-certified-associate-credential). Domande scritte sulle 4 sezioni ufficiali dell'esame (Ecosistema Salesforce, Navigazione, Modello dati, Report e Dashboard), pesate secondo la percentuale reale di ciascuna sezione, più domande aggiuntive tratte dai moduli reali via via completati (es. Agentforce 360, Data 360). La card **"Moduli Trailhead"** ti permette di allenarti su un solo modulo/badge alla volta (es. solo "Nozioni di base su Agentforce 360"), senza mischiarlo con altri temi — Flashcard, Quiz e Statistiche si filtrano di conseguenza. Una checklist ti permette anche di segnare le 4 sezioni ufficiali già studiate sul trailmix; il **Glossario** (ricerca libera dei termini incontrati, es. CRM, RAG, Data 360, Account...) resta invece sempre completo, indipendentemente dal modulo selezionato. Nota: alcuni moduli (es. "Agentforce 360 Platform Basics") sono seguiti in inglese, quando anche il contenuto Trailhead originale è in inglese — gli altri restano in italiano.
