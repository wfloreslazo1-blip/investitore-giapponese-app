...
- **Fiscalità** — ripasso del corso interno EY GCR (Global Compliance and Reporting) sul TUIR: 260 domande su 26 lezioni (articoli TUIR + 2 direttive UE + convenzioni OCSE), organizzate in 5 macro-aree, grounded nel materiale delle lezioni e nei manuali di riferimento Ceppellini e Andreani-Dodero-Ferranti. Stesso contenuto della sezione Fiscalità nella wiki Obsidian "Wiki Trial" (`wiki/summaries/fiscalita/quiz-fiscalita-indice.md`) — portato qui il 2026-08-06 per poterci fare pratica anche dal telefono, con lo stesso meccanismo di ripetizione dilazionata delle altre sezioni. La card **"Lezioni"** permette di allenarsi su una singola lezione alla volta; una checklist permette di segnare le macro-aree già ripassate. **Non è il quiz ufficiale EY** né sostituisce la normativa o i manuali per un caso reale con un cliente.
- **Precisione** — percorso a parte pensato per allenare la cura nel dettaglio, non un argomento specifico. Riusa le stesse domande delle altre sezioni (scegli l'argomento — Lettura, Hiragana, Vocaboli, Carriera o Fiscalità — e le domande si adeguano), ma con una modalità diversa: si seleziona una risposta, si conferma esplicitamente, e solo dopo si scopre se è corretta — niente passaggio automatico alla domanda successiva. Tiene traccia di una "serie" di risposte giuste consecutive (attuale e record) per argomento, proprio per premiare l'azzeccarla la prima volta invece della velocità.
